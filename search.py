...
def search_loblaws(code : str):
    ...
    loblaws_same = []
    with open('loblaws.json', 'r') as lobl :
        data = json.load(lobl)
...
def search_saveonfoods(code : str):
    ...
    saveonfoods_same = []
    with open('saveonfoods.json', 'r') as lobl :
        data = json.load(lobl)
        for i in range(0, len(data)):
            if data[i]['code'] == code:
...
def search_wallmart(code : str):
    ...
    wallmart_same = []
    with open('wallmart.json', 'r') as lobl :
        data = json.load(lobl)
        for i in range(0, len(data)):
            if data[i]['code'] == code:
...
def search_nofrills(code : str):
    ...
    nofrills_same = []
    with open('nofrills.json', 'r') as lobl :
        data = json.load(lobl)
        for i in range(0, len(data)):
            if data[i]['code'] == code:
...
def search_realcanadiansuperstore(code : str):
    ...
    with open('realcanadiansuperstore.json', 'r') as lobl :
        data = json.load(lobl)
        for i in range(0, len(data)):
            if data[i]['code'] == code:
